<?php
// Purpose: Fetch top business headlines from NewsAPI page external website and return the JSON to the client page.
...
// Configure cURL Setting CURLOPT_RETURNTRANSFER to true "Don't print the response. Give it back to me as a string."
