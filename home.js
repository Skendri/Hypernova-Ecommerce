        document.addEventListener("DOMContentLoaded", function() {
            ...
            fetch('https://newsapi.org/v2/everything?q=apple&from=2026-04-03&to=2026-04-03&sortBy=popularity&apiKey=')
                .then(response => response.json())
                .then(data => {
                    console.log(data);
                    ...
                    articles.forEach(article => {
                        const image = article.urlToImage ? `<img src="${article.urlToImage}" class="card-img-top" alt="${article.title}" style="height: 200px; object-fit: cover;">` : '<div class="card-img-top bg-secondary" style="height: 200px;"></div>';
                        html += `
                ...
                .catch(error => {
                    ...
                    document.getElementById('news-container').innerHTML = '<p class="p-4">Error loading news.</p>';
                });
            // news fetching from newsapi.org
